  ...
  return (
    <Layout>
      ...
      <div className="container pt-6">
        <PolicyBreadcrumb items={[{ label: "Higher Education", href: "/higher-ed" }, { label: "Tennessee Promise" }]} />
      </div>
      ...
      <header className="container py-8 border-b border-border">
        ...
        <h1 className="font-serif text-3xl md:text-4xl font-bold mb-3">Tennessee Promise</h1>
          ...
          <Tabs defaultValue="overview" className="w-full">
            ...
            <TabsContent value="overview" className="prose-article">
              ...
              <p>
                ...
                college experience, from application to completion. This mentorship is a required component of the
                program.
              </p>
            </TabsContent>
            ...
            <TabsContent value="eligibility" className="prose-article">
              ...
              <p>To qualify for Tennessee Promise, students must meet the following requirements:</p>
              <ul>
              ...
              <p>
                Students can use Tennessee Promise at any of the state's 13 community colleges or 27 colleges of applied
                technology (TCATs). In Nashville, this includes Nashville State Community College and Tennessee College
                of Applied Technology Nashville.
              </p>
            </TabsContent>
            ...
            <TabsContent value="impact" className="prose-article">
              ...
              <p>
                Since its launch in 2015, Tennessee Promise has significantly increased college enrollment among high
                school graduates, particularly among first-generation college students.
              </p>
            ...
            <TabsContent value="how-to-apply" className="prose-article">
              ...
              <ol>
                ...
                <li>
                  <strong>Complete the FAFSA</strong> — Submit your Free Application for Federal Student Aid by the
                  priority deadline (typically January 15th).
                </li>
                <li>
                  <strong>Attend mandatory meetings</strong> — Participate in all required meetings held in your county
                  (usually 2-3 meetings per year).
                </li>
                <li>
                  <strong>Connect with your mentor</strong> — You'll be assigned a volunteer mentor who will guide you
                  through the process.
                </li>
                <li>
                ...
                <li>
                  <strong>Complete community service</strong> — 8 hours of community service are required each semester
              ...
              <div className="mt-8 p-6 bg-primary text-primary-foreground rounded-lg">
                ...
                <Button variant="secondary" asChild>
                  <a href="https://www.tn.gov/tnpromise" target="_blank" rel="noopener noreferrer">
