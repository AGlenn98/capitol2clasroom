...
import { ArrowRight, BookOpen, GraduationCap, Scale, Megaphone, AlertCircle, Search, Filter } from "lucide-react";
...
const navigationCards = [
  {
    ...
    description: "MNPS, charter schools, funding",
    actionLabel: "Explore K-12",
  },
  {
    to: "/higher-ed",
    icon: BookOpen,
    title: "Higher Education",
    description: "Universities, workforce programs",
    actionLabel: "Explore Higher Ed",
  },
  {
    to: "/advocacy",
    icon: Scale,
    title: "Bill Track List",
    description: "Track bills, take action",
    ...
    <Layout>
      ...
      <section className="hero-gradient text-primary-foreground py-16 lg:py-20 relative" aria-labelledby="hero-heading">
        ...
        <div className="container relative z-10">
          <div className="max-w-3xl">
            <h1
              id="hero-heading"
              className="font-display text-5xl md:text-6xl lg:text-7xl tracking-wide mb-4 animate-fade-in"
            >
              Tennessee Education Bill Tracker
            </h1>
            <p
              className="text-lg text-primary-foreground/85 mb-6 leading-relaxed animate-fade-in font-sans max-w-2xl"
              style={{ animationDelay: "0.1s" }}
            >
              Capitol to Classroom acts as a source for tracking education legislation. Search bills, contact
      ...
      <section className="py-8 -mt-6 relative z-10" aria-labelledby="bills-heading">
        <div className="container">
            ...
            <div className="flex flex-col md:flex-row gap-4 items-center">
              <div className="relative flex-1 w-full">
                ...
                <Input
                  ...
                  className="pl-10 h-12 text-base rounded-lg border-2 border-border"
                  value={searchQuery}
              ...
              <div className="flex gap-3 w-full md:w-auto">
                <Link to="/advocacy" className="flex-1 md:flex-initial">
                  <Button
                    variant="default"
                    className="w-full gap-2 rounded-lg h-12 font-display tracking-wider uppercase bg-accent hover:bg-accent/90"
                  >
          ...
          <h2 id="bills-heading" className="font-display text-3xl md:text-4xl tracking-wide mb-6">
          ...
          {!isLoading && !error && filteredBills.length > 12 && (
            <div className="text-center mt-8">
              <Link to="/advocacy">
                <Button
                  size="lg"
                  className="gap-2 rounded-lg font-display tracking-wider uppercase bg-accent hover:bg-accent/90"
                >
          ...
          <ul className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {navigationCards.map((card) => (
              <li key={card.to}>
                <Link
                  to={card.to}
                  className="group flex flex-col items-center text-center p-5 bg-card border-2 border-border rounded-lg hover:border-accent hover:shadow-card transition-all h-full"
                >
      ...
      <section className="py-16 hero-gradient text-primary-foreground relative">
        ...
        <div className="container relative z-10">
          <div className="max-w-xl mx-auto text-center">
            ...
            <p className="text-primary-foreground/85 mb-6 font-sans">
