...
import { ArrowRight, BookOpen, GraduationCap, Scale, Megaphone, AlertCircle, Sparkles, Search, Filter } from "lucide-react";
...
export default function Index() {
  ...
  return (
    <Layout>
      ...
      <section 
        className="hero-gradient text-primary-foreground py-12 lg:py-16"
      ...
      >
        ...
        <div className="container">
          <div className="max-w-3xl">
            ...
            >
              Your nonpartisan source for tracking education legislation. 
              Search bills, contact legislators, and make your voice heard.
            </p>
          </div>
        </div>
      </section>
      ...
      <section 
        className="py-8 -mt-6 relative z-10"
        ...
        <div className="container">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground max-w-xl mx-auto">
              Dive deeper into Tennessee education policy
            </p>
          </div>
      ...
      {/* Newsletter CTA */}
      <section 
        className="py-16 hero-gradient text-primary-foreground"
