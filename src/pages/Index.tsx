...
const stats = [
  { label: "Students Served by MNPS", value: "80,000+", icon: Users },
  { label: "Active Education Bills", value: "42", icon: Scale },
  { label: "Year-over-Year Funding Change", value: "+3.2%", icon: TrendingUp }
];
    ...
    <Layout>
      ...
      <section className="relative bg-primary text-primary-foreground py-16 lg:py-24">
        <div className="container">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-primary-foreground/80 mb-6 leading-relaxed animate-fade-in" style={{ animationDelay: "0.1s" }}>
      ...
      <section className="py-8 border-b border-border bg-muted/30">
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {stats.map(stat => (
              <div key={stat.label} className="flex items-center gap-3 p-4 bg-card rounded-lg border border-border">
      ...
      <section className="py-12">
        <div className="container">
          ...
          {error && (
            <div className="p-6 bg-destructive/5 border border-destructive/20 rounded-lg flex items-start gap-3">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {navigationCards.map(card => (
              <Link
                key={card.to}
                to={card.to}
                className="group flex flex-col items-center text-center p-5 bg-card border border-border rounded-lg hover:border-accent hover:shadow-md transition-all"
              >
