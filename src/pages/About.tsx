        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 prose-article">
              ...
              <p className="text-muted-foreground mb-4">We follow several guiding principles in our work:</p>
              <ul className="space-y-4 mb-8">
                <li className="flex items-start gap-3">
                  <span className="flex items-center justify-center w-6 h-6 rounded-full bg-accent/20 text-accent-foreground text-sm font-bold shrink-0 mt-0.5">
                    1
                  </span>
                  <div>
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      We rely on primary sources, peer-reviewed research, and official data. All claims are sourced, and
                      we clearly distinguish between facts and analysis.
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      Policy can be complex, but explanations don't have to be. We translate jargon into plain language
                      and provide context for all topics.
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      While we cover state and federal policy, we always connect it back to Nashville. What does this
                      mean for MNPS? For local families? For our community?
                    </p>
                  </div>
                </li>
              </ul>
              ...
              <p className="text-muted-foreground mb-4">Nashville Policy Compass is designed for:</p>
              <ul className="space-y-2 text-muted-foreground mb-8">
                <li>
                  • <span className="text-foreground">Parents and families</span> seeking to understand policies
                  affecting their children's education
                </li>
                <li>
                  • <span className="text-foreground">Educators</span> who want to stay informed about legislative
                  developments
                </li>
                <li>
                  • <span className="text-foreground">Community members</span> interested in civic engagement
                </li>
                <li>
                  • <span className="text-foreground">Policymakers and staff</span> who need accessible summaries and
                  analysis
                </li>
                <li>
