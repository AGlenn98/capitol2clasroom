...
export function AdvocacyBar({
  ...
  return (
    <div className={cn("bg-card border border-border rounded-lg p-6 space-y-6 sticky top-24", className)}>
      ...
      {/* Stance Toggle */}
      <StanceToggle stance={stance} onStanceChange={onStanceChange} />
      ...
      <div className="space-y-3">
        <ContactLegislator billNumber={billNumber} billTitle={billTitle} stance={stance} sponsors={sponsors} />

        <SocialShare billNumber={billNumber} billTitle={billTitle} billUrl={billUrl} stance={stance} />
      </div>
