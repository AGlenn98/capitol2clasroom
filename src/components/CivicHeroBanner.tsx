...
export function CivicHeroBanner({ searchQuery, onSearchChange }: CivicHeroBannerProps) {
  ...
  return (
    <header 
      className="civic-hero relative min-h-[85vh] flex flex-col justify-center items-center overflow-hidden"
      ...
      <div className="container relative z-10 flex flex-col items-center justify-center text-center py-16">
        ...
        >
          ...
          <div className="relative inline-block">
            ...
            <div className="bg-civic-red inline-block p-6 sm:p-8 lg:p-12">
              <h1 
                id="hero-heading"
                className="font-display text-[4rem] sm:text-[6rem] md:text-[8rem] lg:text-[10rem] xl:text-[12rem] leading-[0.85] tracking-tight"
              >
        ...
        <div 
          className={`mt-12 sm:mt-16 w-full max-w-2xl transition-all duration-300 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}
